...
var rskUtils = require('@rsksmart/rsk-utils');
...
const Account = props => {
  ...
  const [wrongNetModalOpen, setWrongNetModalOpen] = React.useState(false);
  ...
  const accountText = () => {
    ...
    if (account) {
      return shortenString(rskUtils.toChecksumAddress(account, requiredNetworkId));
    }
...
const HeaderDesktop = ({
  ...
  return React__default.createElement(core.AppBar, {
    position: "fixed",
    className: classes.root
  }, React__default.createElement(core.Toolbar, null, React__default.createElement(core.Grid, {
    container: true
  }, React__default.createElement(core.Grid, {
    item: true,
    xs: 1
...
const HeaderMobile = ({
  ...
  }, React__default.createElement(core.Toolbar, null, !open && React__default.createElement(core.Grid, {
    container: true
  }, React__default.createElement(core.Grid, {
    item: true,
    xs: 1
...
exports.NetworkIndicator = NetworkIndicator;
...
exports.WrongNetworkModal = WrongNetworkModal;
exports.colors = colors;
exports.defaultWeb3State = defaultWeb3State;
...
exports.logoBlueIcon = logoBlueIcon;
